...
module.exports = Object.freeze({
    ...
    PAGO_VERIFICADO: '👩🏻 Apreciado usuario le informamos que *hemos recibido satisfactoriamente el pago* reportado por usted a nombre de *{CLIENTE}*, realizado a través de *{MEDIO}* el pasado *{FECHA}* en la cuenta *{CUENTA}* perteneciente a *{TITULAR}* por valor de *{VALOR}*.\n\nGracias por su pago oportuno.',
